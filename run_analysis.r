...
SubjectsTrain <- read.table("/Users/xunwang/Dropbox/courses/data/cleaningData/UCI HAR Dataset/train/subject_train.txt", stringsAsFactors = FALSE)
ActivityTrain <- read.table("/Users/xunwang/Dropbox/courses/data/cleaningData/UCI HAR Dataset/train/y_train.txt", stringsAsFactors = FALSE)
SubjectsTest <- read.table("/Users/xunwang/Dropbox/courses/data/cleaningData/UCI HAR Dataset/test/subject_test.txt", stringsAsFactors = FALSE)
ActivityTest <- read.table("/Users/xunwang/Dropbox/courses/data/cleaningData/UCI HAR Dataset/test/y_test.txt", stringsAsFactors = FALSE)
